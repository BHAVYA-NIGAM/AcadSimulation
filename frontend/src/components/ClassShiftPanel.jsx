...
export default function ClassShiftPanel({
  ...
  return (
    <section className="theme-surface rounded-[24px] border p-4">
      <div className="mb-4">
        <h4 className="theme-heading text-base font-semibold">{title}</h4>
      ...
      <div className="grid gap-3 lg:grid-cols-[1.4fr_1fr_auto]">
        <select
          ...
          className="theme-input rounded-2xl border px-4 py-3 text-sm outline-none transition focus:border-orange-300"
        >
        ...
        <select
          ...
          className="theme-input rounded-2xl border px-4 py-3 text-sm outline-none transition focus:border-orange-300 disabled:cursor-not-allowed disabled:opacity-60"
        >
          <option value="">
        ...
        <button
          ...
          className="theme-button-orange rounded-2xl px-4 py-3 disabled:cursor-not-allowed disabled:opacity-60"
        >
      ...
      {error ? (
        <p className="theme-alert-error mt-3 rounded-xl border px-3 py-2 text-sm">{error}</p>
      ) : null}
    </section>
  );
}
