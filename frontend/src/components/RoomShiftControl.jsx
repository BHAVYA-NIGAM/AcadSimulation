    ...
    <div className="mt-4 space-y-2">
      <div className="flex gap-2">
        <select
          ...
          className="theme-input w-full rounded-xl border px-3 py-2 text-sm outline-none transition focus:border-orange-300"
        >
        ...
        <button
          ...
          className="theme-button-orange rounded-xl px-3 py-2 disabled:cursor-not-allowed disabled:opacity-60"
        >
      ...
      {error ? (
        <p className="theme-alert-error rounded-xl border px-3 py-2 text-xs">{error}</p>
      ) : null}
    </div>
  );
}
